...
function privacypolicy() {
  return (
    <>
      <Head>
        <title>Tailwindly - Privacy Policy</title>
        <meta
          name="description"
      ...
      <div className="bg-white px-4 py-14 dark:bg-slate-800 sm:py-16 lg:py-20">
        <div className="prose prose-sm mx-auto max-w-[37.5rem] text-gray-500 dark:text-gray-200">
          <p>
            ...
            through the Tailwindly website (tailwindui.netlify.app) or in the
            course of purchasing any Tailwindly products
          ...
          <h2 className="my-4 text-2xl font-bold text-gray-800 dark:text-white">
          ...
          <p>
            ...
            to login to the Website and access any purchased Tailwindly
            products.{" "}
          </p>
          <h2 className="my-4 text-2xl font-bold text-gray-800 dark:text-white">
          ...
          <p>
            ...
            processing, and in particular whether the provision of Personal Data
          ...
          <p>
            ...
            and obtain a copy of the information undergoing processing; <br />
            (iv) you have the right to verify the accuracy of your information
            and ask for it to be updated or corrected; <br />
          ...
          <p>
            ...
            Information, you acknowledge that <br />
