    ...
    <>
      ...
      <div className="mx-auto max-w-[85rem] bg-gray-50 px-4 py-20 dark:bg-gray-900 sm:px-6 lg:px-8">
        ...
        {show ? (
          ...
          <div className="h-[250px] w-full overflow-auto rounded-lg border border-gray-900 bg-gray-800  text-gray-100 md:h-[500px]">
            <code>
              {`<div className="scrolling-touch inline-block p-4 subpixel-antialiased">
